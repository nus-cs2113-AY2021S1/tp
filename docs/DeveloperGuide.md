...
Note: Before printing the countdown, `countdown()` function will calculate the countdown of exams or deadlines, and the countdowns
will be sorted in ascending sequence `sortDeadlinesAndPrintCountdown()` or `sortExamsAndPrintCountdown()`
