...
1. Example:
    * The `checkAndReturnDate()` in [`ParamChecker`](https://github.com/AY2021S1-CS2113-T16-1/tp/blob/master/src/main/java/seedu/financeit/utils/ParamChecker.java) checks validity of dates supplied from user input.
