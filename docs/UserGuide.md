...
1. Use the command `help` to get a list of commands and their usages before using the application.
...
Edit note | `edit /i 2 /t JavaDocs Notes`<br>`edit /i 2 /ln 1 /c @param refers to parameters`<br>`edit /i 2 /tag Notes`<br> Or any combination with `/t`, [`/ln` + /`c`] and `/tag` 
