...
class SmartHomeBotTest {
    ...
    @Test
    public void locationList_AddLocation_test() throws DuplicateDataException {
        ...
        assertThrows(DuplicateDataException.class, () -> locationList.addLocation(br1));
    }

    @Test
    public void applianceList_addAppliance_Test() throws DuplicateDataException {
        ...
        assertThrows(DuplicateDataException.class, () -> applianceList.addAppliance(l1));
