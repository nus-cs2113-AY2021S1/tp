    ...
    public static void fileParser(String command, DateList dateList) {
        ...
        case L: {
            ...
            for (int i = 0; i < durationNum; i++) {
                // assert words[ 5 + 2 * i + 1].contains("//") : "File should contain //"; TODO: Fix this assertion error
                LocalDateTime start = LocalDateTime.parse(words[5 + 2 * i + 1]);
                // assert words[5 + 2 * i + 2].contains("//") : "File should contain //"; TODO: Fix this assertion error
