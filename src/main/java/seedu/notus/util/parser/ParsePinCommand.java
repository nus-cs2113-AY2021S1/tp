...
/**
 * Represents a parser object specifically to parse message for ParsePinCommand.
 */
public class ParsePinCommand extends Parser {

    public ParsePinCommand(String userMessage) {
        super(userMessage);
    }
