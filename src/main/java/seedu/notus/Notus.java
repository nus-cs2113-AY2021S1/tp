...
public class Notus {
    ...
    private void init() {
        ...
        try {
            ...
            storageManager.loadAllNotes(notebook,tagManager, parserManager, false);
            storageManager.loadAllNotes(notebook, tagManager, parserManager, true);
            storageManager.loadTimetable(timetable, parserManager);
