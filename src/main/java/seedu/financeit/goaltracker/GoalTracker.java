    ...
    public static void targetGoalTracker(Entry entry) {
        ...
        if (entryCategory.equals("Expense")) {
            try {
                ...
                if (goalDifference < 0) {
                    UiManager.printWithStatusIcon(Constants.PrintType.SYS_MSG, "Expense Budget Updated, "
                ...
                UiManager.printWithStatusIcon(Constants.PrintType.SYS_MSG, "You did not set "
                        + "a goal for expense.");
            ...
            try {
                ...
                if (goalDifference < 0) {
                    UiManager.printWithStatusIcon(Constants.PrintType.SYS_MSG, "Revenue Goal Updated, "
