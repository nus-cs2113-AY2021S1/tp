...
public class FinanceList {
    ...
    public static String addLog(FinanceLog fl) {
            financeLogs.add(fl);
            String output1 = "Got it! I've added this to the list.\n";
            String output2 = fl.toString();
            String output3;
            if (fl.getSize() > 1) {
                output3 = "There are " + fl.getSize() + " logs in the list now.\n";
            } else {
                output3 = "There is " + fl.getSize() + " log in the list now.\n";
            }
