...
public class SprintHelpCommand extends Command {
    ...
    public void execute() {
        ...
        Ui.showToUserLn("   Example: sprint /edit -goal Add Documentation");
        Ui.showToUserLn("   Example: sprint /edit -project 2 -goal Add Documentation");
        Ui.showToUserLn("   Example: sprint /edit -project 2 -sprint 3 -goal Add Documentation");
        Ui.showToUserLn("4. Add tasks to sprint");
        Ui.showToUserLn("   Format: sprint /addtask <task_id> [<task_id> ...] [optional tags]");
        Ui.showToUserLn("   Example: sprint /addtask 1 2");
        Ui.showToUserLn("   Example: sprint /addtask -task 1 2");
        Ui.showToUserLn("   Example: sprint /addtask -project 2 -task 1 2");
        Ui.showToUserLn("   Example: sprint /addtask -project 2 -sprint 3 -task 1 2");
        Ui.showToUserLn("5. Delete tasks from sprint");
        Ui.showToUserLn("   Format: sprint /removetask <task_id> [<task_id> ...] [optional tags]");
        Ui.showToUserLn("   Example: sprint /removetask 1 2");
        Ui.showToUserLn("   Example: sprint /removetask -project 2 -task 1 2");
        Ui.showToUserLn("   Example: sprint /removetask -project 2 -sprint 3 -task 1 2");
        ...
        Ui.showToUserLn("   Example: sprint /allocate -task 1 2 -user johntan mary jane");
        Ui.showToUserLn("   Example: sprint /allocate -project 2 -task 1 -user mary");
        Ui.showToUserLn("   Example: sprint /allocate -project 2 -sprint 3 -task 1 -user mary");
        ...
        Ui.showToUserLn("   Example: sprint /deallocate -task 1 2 -user johntan mary jane");
        Ui.showToUserLn("   Example: sprint /deallocate -project 2 -task 1 -user mary");
        Ui.showToUserLn("   Example: sprint /deallocate -project 2 -sprint 3 -task 1 -user mary");
    }
}
